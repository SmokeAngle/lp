 ...
 */
!defined('MEMCACHE_SERIALIZED') && define("MEMCACHE_SERIALIZED", 1<<0);

/**
 * Flag: indicates data is compressed
 */
!defined('MEMCACHE_COMPRESSED') && define("MEMCACHE_COMPRESSED", 1<<1);
 ...
 */
!defined('COMPRESSION_SAVINGS') && define("COMPRESSION_SAVINGS", 0.20);
...
class MemcachedClient
{
   ...
   // {{{ memcached()
    ...
    {
        return $this->MemcachedClient($args);
    }
